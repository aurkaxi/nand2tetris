module tb_And16;
  ...
  initial begin
    ...
    check(16'b0000000000000000, 16'b1111111111111111, 16'b0000000000000000);
    check(16'b1111111111111111, 16'b1111111111111111, 16'b1111111111111111);
    check(16'b1010101010101010, 16'b0101010101010101, 16'b0000000000000000);
    check(16'b0011110011000011, 16'b0000111111110000, 16'b0000110011000000);
    check(16'b0001001000110100, 16'b1001100001110110, 16'b0001000000110100);
  end
